defmodule PhxTestWeb.UserControllerTest do
  use PhxTestWeb.ConnCase

  import PhxTest.AccountsFixtures

  @create_attrs %{name: "some name", location: "some location", age: 120.5}
  @update_attrs %{name: "some updated name", location: "some updated location", age: 456.7}
  @invalid_attrs %{name: nil, location: nil, age: nil}
