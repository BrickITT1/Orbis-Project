...
export const VoiceMemberManager: React.FC = () => {
          ...
          return (
            <li key={myPeer.peerId}>
              ...
              <div className="voice-name">
                ...
                {!myPeer.audioOnly && <span> <svg width="20" height="20" viewBox="0 0 48 37" fill="none" xmlns="http://www.w3.org/2000/svg">
